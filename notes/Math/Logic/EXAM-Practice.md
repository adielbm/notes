...
> Prove ([[Structural Induction|structure induction]]) that if the formulas $B_1\leftrightarrow B_1',B_2\leftrightarrow B_2',...,B_n\leftrightarrow B_n'$ are [[Math/Logic/Predicate Logic/Semantic#Logical Validity|logically valid]], then the formula $A\leftrightarrow A'$ is logically valid.
