...
- A formula of a formal language is a **valid** formula if and only if it is true under every possible interpretation of the language. (in Propositional Logic, they are [[Math/Logic/Propositional Logic/Semantic#Logical Validity|tautologies]])
