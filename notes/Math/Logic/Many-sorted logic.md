...
- Connectives, Quantifiers, Equality, and Parentheses are the same as in [[Math/Logic/Predicate Logic/Syntax#Logical symbols|First-order logic]]
...
- [[Math/Logic/Predicate Logic/Syntax#Formulas|Formulas]] and [[Math/Logic/Predicate Logic/Syntax#Sentence|sentences]] as in FOL

# Semantics

- [[Math/Logic/Predicate Logic/Semantic#Variable Assignment|Variable Assignment]], as in FOL, but with the additional requirement that each variable is assigned a value from its sort
