...
### Semantic completeness
 ...
 - A proof calculus is **semantically complete** (or **weak complete**) if we have: 
	 ...
	 - Every tautology is provable
		- (tautology: [[Math/Logic/Propositional Logic/Semantic#Logical Validity|PL]], [[Math/Logic/Predicate Logic/Semantic#Logical Validity|FOL]]; provable: [[Propositional Calculus#Provable Proposition|PL]], [[Predicate Calculus#Provable Formula|FOL]])
### Soundness
