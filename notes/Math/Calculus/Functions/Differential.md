...
![[Differentials in two variables.svg|(from: Calculus: Early transcendentals (p. 455), by J. Stewart, D. K. Clegg, and S. Watson, 2020, Cengage Learning)|468]]
...
- $dz = \nabla z \cdot d\mathbf{r}$ where:
	- $\nabla z$ is the [[Vector calculus#Gradient|gradient]] of $z$
	- $d\mathbf{r} = (dx, dy)$
