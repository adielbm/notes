...
- (5.13 MCT) $(a_n)\geq0\iff(s_n)$ is [[Math/Calculus/Sequences/Monotonicity|increasing]]. In this case:
...
- (5.18) Cauchy condensation test - Let $(a_n)$ be a [[Math/Calculus/Sequences/Monotonicity|decreasing]] sequence of nonnegative terms. The series $\sum_{n=1}^{\infty}a_n$ converges if and only if the series $\sum_{n=1}^{\infty}2^na_{2^n}$ converges.
...
- (5.22) Let $\sum a_k$ be a [[Series#bounded series|bounded]] series, and $(b_k)$ be a [[Math/Calculus/Sequences/Monotonicity|monotone]] [[Math/Calculus/Sequences/Limit#Null Sequence|null sequence]]. Then the series $\sum a_kb_k$ converges.
