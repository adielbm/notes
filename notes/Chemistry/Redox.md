...
- $\ce{\underset{ oxidant }{ Cr2O7^2- }(aq) + 6\underset{ reductant }{ Fe^2+ }(aq) + 14H+(aq) -> 2Cr^3+(aq) + 6Fe^3+(aq) + 7H2O(l)}$
- $\ce{\underset{ reductant }{ 2Al } + \underset{ oxidant }{ Fe2O3 } -> Al2O3 + 2Fe}$ (thermite reaction)
- **corrosion** (קורוזיה, שיתוך)
	- **rust**
		- $\ce{\underset{ reductant }{ 4Fe(s) } + \underset{ oxidant }{ 3O2(g) } -> 2Fe2O3(s)}$ (rusting of iron)
...
- stoichiometric combustion of a hydrocarbon in oxygen:
	- $\ce{\underset{reductant}{ C_{x}H_{y} } + \left(\mathit{x}+\frac{\mathit{y}}{4}\right) \underset{oxidant}{O2} -> \mathit{x} CO2 + \frac{\mathit{y}}{2}H2O}$
		- $\ce{CH4 + 2O2 -> CO2 + 2H2O}$
