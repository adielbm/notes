...
- $K_a = \frac{[\ce{H3O+}][\ce{A^-}]}{[\ce{HA}]},\quad K_b = \frac{[\ce{BH+}][\ce{OH^-}]}{[\ce{B}]}$
- $\mathrm{p}K_{a}=-\log_{10}K_{a},\quad \mathrm{p}K_{b}=-\log_{10}K_{b}$
- $\ce{2H2O <=> H3O+ + OH-}$
...
- The **oxidizing agent** (or **oxidant**) (גורם מחמצן) is the species that:
	...
	- undergoes **reduction** (or being **reduced** (מתחזר)) which is to: decrease in its oxidation number of one of its atoms
- The **reducing agent** (or **reductant**) (גורם מחזר) is the species that: 
	- **reduces** (מחזר) (or causes **reduction** to) the oxidant
	- undergoes **oxidation** (or being **oxidized** (מתחמצן)) which is to: increase in its oxidation number of one of its atoms
- An atom of a free element has an oxidation number of $0$. (e.x. $\ce{Cl}$ atom in $\ce{Cl2}$ has an O.N. of $0$)
...
- oxygen: $-2$ in most of its compounds

---

- **boiling point**, $T_\text{b}$ s.t. $P_{\text{vap}}(T_\text{b})=P_{\text{ext}}$
