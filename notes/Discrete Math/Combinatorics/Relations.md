...
Number of [[Discrete Math/Set theory/Relations]]s on a **single set** $A$ (s.t. $|A|=n$ ). ^[https://en.wikipedia.org/wiki/Template:Number_of_relations] ^[https://math24.net/counting-relations.html].
...
| [[Discrete Math/Set theory/Relations#Equivalence relation\|Equivalence relation]]   | [[Bell numbers]] |
| Total Order | $n!$ |
