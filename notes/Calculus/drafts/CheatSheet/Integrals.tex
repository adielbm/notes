...
(2.10) & $\int \ln^2x \, dx=x\ln^2x-2x\ln x+2x+C$ \\
...
($u=f(x)\longleftarrow$ LIATE $\longrightarrow g'(x)\, dx$)
...
\begin{array}{|c|c|c|c|}
\hline
\text{Expression} & \text{Substitution} & \text{Domain} & \text{Simplified Expression} \\
\hline
a^2 - x^2 & \begin{array}{c} x = a \sin t \\ dx = a \cos t \, dt \\ t = \arcsin \frac{x}{a} \end{array} & -\frac{\pi}{2} \leq t \leq \frac{\pi}{2} & a^2 \cos^2 t \\
\hline
a^2 + x^2 & \begin{array}{c} x = a \tan t \\ dx = a \sec^2 t \, dt \\ t = \arctan \frac{x}{a} \end{array} & -\frac{\pi}{2} < t < \frac{\pi}{2} & a^2 \sec^2 t \\
\hline
x^2 - a^2 & \begin{array}{c} x = a \sec t \\ dx = a \sec t \tan t \, dt \\ t = \text{arcsec} \frac{x}{a} \end{array} & \begin{array}{c} 0 \leq t < \frac{\pi}{2} \\ \pi \leq t < \frac{3\pi}{2} \end{array} & a^2 \tan^2 t \\
\hline
\end{array}
